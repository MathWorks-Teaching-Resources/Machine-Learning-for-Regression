...
%[text]{"align":"center"} ![Optimization by gradient descent](text:image:524a)
%[text:tableOfContents]{"heading":"Table of Contents"}
%[text] **Before you get started:**
%[text] %[text:anchor:H_BF646A47] This live script is intended to be used with the code hidden. On the **View** tab of the MATLAB toolstrip, in the **View** section, select **Hide Code**.  Alternately, select **Hide Code** using the icon ![live script code hidden icon](text:image:19f2) at the top right of the Live Editor pane.
...
CheckAnswer("Exercise1","c.")  %[control:dropdown:0bb0]{"position":[25,29]}
%%
...
%[text]{"align":"center"} ![](text:image:6950)
...
ErrorScale = 3; %[control:spinner:5f58]{"position":[14,15]}
  %[control:button:80e5]{"position":[1,2]}
...
ApplyDefaultAxesStyle(gca,DefaultStyle)
  %[control:button:97e4]{"position":[1,2]}
%%
...
ApplyDefaultStyle(DefaultStyle);
if exist("Data","var")
Theta1 = 2; %[control:slider:1a05]{"position":[10,11]}
Theta0 = 3; %[control:slider:4feb]{"position":[10,11]}
  %[control:button:970d]{"position":[1,2]}
Guess = [Theta1 Theta0];
...
CheckAnswer("Exercise2","Select") %[control:dropdown:073e]{"position":[25,33]}
%%
...
CheckAnswer("Exercise3","a."); %[control:dropdown:9021]{"position":[25,29]}
%%
...
DefaultStyle = DefaultPlotStyle();
ApplyDefaultStyle(DefaultStyle);
LearningRateChoice2D = 2; %[control:slider:4690]{"position":[24,25]}
...
LearningRate = 0.16; %[control:slider:454b]{"position":[16,20]}
NumSteps = 80; %[control:slider:319c]{"position":[12,14]}
  %[control:button:888b]{"position":[1,2]}
...
CheckAnswer("Exercise4","d.") %[control:dropdown:1221]{"position":[25,29]}
%%
%[text] ## Summary
...
%[text] Review the [Additional Resources](file:../AdditionalResources.m:M_6138) section to find more materials for further learning.
%%
...
%   data: {"align":"baseline","height":20,"src":"data:image\/png;base64,","width":22}
%---
%[control:dropdown:0bb0]
%   data: {"defaultValue":"\"c.\"","itemLabels":["Select","a.","b.","c.","d."],"items":["\"Select\"","\"a.\"","\"b.\"","\"c.\"","\"d.\""],"label":"Select an answer.","run":"SectionAndStaleSectionsAbove"}
%---
%[text:image:6950]
...
%   data: {"align":"baseline","height":26,"src":"data:image\/png;base64,","width":19}
%---
%[control:spinner:5f58]
%   data: {"defaultValue":3,"label":"Noise Level:","max":5,"min":1,"run":"Section","runOn":"ValueChanging","step":1}
%---
%[control:button:80e5]
...
%---
%[control:slider:1a05]
%   data: {"defaultValue":2,"label":"Theta 1:","max":4,"min":0,"run":"Section","runOn":"ValueChanging","step":0.5}
%---
%[control:slider:4feb]
%   data: {"defaultValue":3,"label":"Theta 0:","max":4,"min":0,"run":"Section","runOn":"ValueChanging","step":0.5}
%---
%[control:button:970d]
...
%   data: {"align":"baseline","height":20,"src":"data:image\/png;base64,","width":22}
%---
%[control:dropdown:073e]
%   data: {"defaultValue":"\"Select\"","itemLabels":["Select","a.","b.","c.","d."],"items":["\"Select\"","\"a.\"","\"b.\"","\"c.\"","\"d.\""],"label":"Select an answer.","run":"Section"}
%---
%[text:image:019d]
%   data: {"align":"baseline","height":20,"src":"data:image\/png;base64,","width":22}
%---
%[control:dropdown:9021]
%   data: {"defaultValue":"\"a.\"","itemLabels":["Select","a.","b.","c.","d."],"items":["\"Select\"","\"a.\"","\"b.\"","\"c.\"","\"d.\""],"label":"Select an answer.","run":"Section"}
%---
%[text:image:98a4]
%   data: {"align":"baseline","height":26,"src":"data:image\/png;base64,","width":19}
%---
%[control:slider:4690]
%   data: {"defaultValue":2,"label":"LearningRateChoice2D","max":3,"min":0,"run":"Section","runOn":"ValueChanging","step":0.5}
%---
%[control:button:i008]
...
%---
%[control:slider:454b]
%   data: {"defaultValue":0.16,"label":"Learning Rate:","max":0.4,"min":0.1,"run":"Nothing","runOn":"ValueChanged","step":0.01}
%---
%[control:slider:319c]
%   data: {"defaultValue":80,"label":"Number of Steps:","max":140,"min":0,"run":"Nothing","runOn":"ValueChanging","step":10}
%---
%[control:button:888b]
...
%   data: {"defaultValue":"\"d.\"","itemLabels":["Select","a.","b.","c.","d."],"items":["\"Select\"","\"a.\"","\"b.\"","\"c.\"","\"d.\""],"label":"Select an answer.","run":"Section"}
%---
