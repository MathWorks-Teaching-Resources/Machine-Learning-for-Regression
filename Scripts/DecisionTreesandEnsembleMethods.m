...
%[text]{"align":"center"} ![A decision tree](text:image:2549)
%[text:tableOfContents]{"heading":"Table of Contents"} %[text:anchor:M_597CA885]
%[text] %[text:anchor:H_51183E7B] **Before you get started:**
%[text] %[text:anchor:H_BF646A47] This live script is intended to be used with the code hidden. On the MATLAB toolstrip, select **View** \> **Hide Code**. Alternatively, select **Hide Code** using the icon ![live script code hidden icon](text:image:0d1b) at the top right of the Live Editor pane.
%[text] ![Lightbulb mark](text:image:996a) Although the code is hidden, some interactivity requires familiarity with MATLAB. If you need more instruction, consider taking [MATLAB Onramp](https://matlabacademy.mathworks.com/details/matlab-onramp/gettingstarted), a free 2-hour online tutorial that teaches the essentials of MATLAB.
...
%[text] - What kind of pattern can a single tree represent?
...
%[text] ![Finger touching surface icon](text:image:70ff) **Try**. Click **Display Baseline Comparison**. 
DefaultStyle = InitializeDefaultStyle();
  %[control:button:5fe9]{"position":[1,2]}
...
%[text] ![Finger touching surface icon](text:image:3865) **Try**. Click **Display Parts of a Decision Tree**. 
DefaultStyle = InitializeDefaultStyle();
ShowStaticTreeDiagram(MakeTreeTerminologySpec(),DefaultStyle,FigureName="Decision Tree Anatomy",FigureSize=[820 360]);
  %[control:button:439a]{"position":[1,2]}
%%
...
Hour = 0; %[control:slider:88d8]{"position":[8,9]}
Temperature = 0; %[control:slider:8da7]{"position":[15,16]}
...
%[text] %[text:anchor:TMP_0026] ![Lightbulb Icon](text:image:3104) **Reflect**. How many leaf nodes does the tree contain? What variable is used for splitting? What values appear at the leaf nodes? How does this differ from the coefficient-based representation of linear regression? 
%%
...
%[text] 
%[text]{"align":"center"} ![Tree description: if Hour \< 9, predict 4200 MW. Otherwise, check Temp \< 60 deg F. If that condition is true, predict 5100 MW. Otherwise, predict 6200 MW.](text:image:2ecc)
CheckAnswer("Exercise1","Select") %[control:dropdown:4e16]{"position":[25,33]}
%%
...
N =1; %[control:slider:49a5]{"position":[4,5]}
...
%[text] In the top plot, the filled circles are the observed training data. The dashed line is the prediction from a single regression tree, used as a baseline. The bagging and boosting curves show how the ensemble prediction changes as more trees are added.
%[text] In summary, **bagging gain** and **boosting gain** mean the percent reduction in training MSE relative to that single-tree baseline. A positive value means the ensemble fits the training data better than one tree; a negative value means it did worse on training MSE for that setting.
...
DefaultStyle = InitializeDefaultStyle();
[x,y] = GetLoadMayDayData();
NumTrees = 1; %[control:slider:2ed9]{"position":[12,13]}
NumSplits = 1; %[control:slider:8be8]{"position":[13,14]}
  %[control:button:961b]{"position":[1,2]}
...
%[text] ![Lightbulb Icon](text:image:3a50) **Reflect**. How many trees do you think we need before the fit stabilizes? Will adding trees make the prediction more or less flexible? Why might the ensemble outperform a single tree?
%%
...
%[text:table]
%%
%[text] ![Finger touching surface icon](text:image:6b77) **Try**. Select a dataset from the **Select a dataset** dropdown menu and predict which model will perform best based on the pattern you observe.
...
DataSetChoice = "Select"; %[control:dropdown:0ca8]{"position":[17,25]}
...
%[text] ![](text:image:3744) **Try**. Click **Compare Regression Models** to view an example that models the hourly electricity load in a single day.
%%\ Compare Regression Models %[text:anchor:TMP_5a30]
  %[control:button:9485]{"position":[1,2]}
DefaultStyle = InitializeDefaultStyle();
...
figure
hMSE = bar(MSEValues);
hMSE.SeriesIndex = DefaultStyle.ComparisonSeriesIndex;
xticks(1:numel(ModelNames))
xticklabels(ModelNames)
xtickangle(45)
ylabel("MSE",Interpreter=DefaultStyle.Interpreter)
title("Model Comparison",Interpreter=DefaultStyle.Interpreter)
ApplyDefaultAxesStyle(gca,DefaultStyle)

disp(ResultsTable)
%%
%[text] ![Pencil on board icon](text:image:2370) **Exercise 2.** A dataset shows clear thresholds or segmented regions rather than one smooth global trend. Which model is the best first flexible choice?
CheckAnswer("Exercise2","Select"); %[control:dropdown:830a]{"position":[25,33]}
%%
%[text] ![Pencil on board icon](text:image:4185) **Exercise 3.** A dataset shows a complex pattern with trends, noise, and nonlinear relationships. Which model is most appropriate?
CheckAnswer("Exercise3","Select"); %[control:dropdown:0db3]{"position":[25,33]}
%%
%[text] ### Summary
...
%[text] If you wish to see the details of the code, on the MATLAB toolstrip select **View** \> **Output Inline**. Alternatively, select **Output Inline** using the icon ![live script output inline icon](text:image:0cdf) at the top right of the Live Editor pane.
...
%---
%[control:slider:88d8]
%   data: {"defaultValue":0,"label":"Hour:","max":38,"min":0,"run":"Section","runOn":"ValueChanging","step":1}
%---
%[control:slider:8da7]
%   data: {"defaultValue":0,"label":"Temperature:","max":180,"min":0,"run":"Section","runOn":"ValueChanging","step":1}
%---
%[text:image:3104]
...
%   data: {"defaultValue":"\"Select\"","itemLabels":["Select","4200","5100","6200"],"items":["\"Select\"","4200","5100","6200"],"label":"Select an answer.","run":"Section"}
%---
%[text:image:3875]
%   data: {"align":"baseline","height":26,"src":"data:image\/png;base64,","width":19}
%---
%[control:slider:49a5]
%   data: {"defaultValue":1,"label":"Number of Splits:","max":6,"min":1,"run":"Section","runOn":"ValueChanging","step":1}
%---
%[text:image:568c]
%   data: {"align":"baseline","height":26,"src":"data:image\/png;base64,","width":19}
%---
%[control:slider:2ed9]
%   data: {"defaultValue":1,"label":"NumTrees:","max":10,"min":1,"run":"Section","runOn":"ValueChanging","step":1}
%---
%[control:slider:8be8]
%   data: {"defaultValue":1,"label":"NumSplits:","max":5,"min":1,"run":"Section","runOn":"ValueChanging","step":1}
%---
%[control:button:961b]
...
%   data: {"align":"baseline","height":26,"src":"data:image\/png;base64,","width":19}
%---
%[control:dropdown:0ca8]
%   data: {"defaultValue":"\"Select\"","itemLabels":["Select","Dataset 1: Mostly Linear","Dataset 2: Nonlinear","Dataset 3: Complex","Dataset 4: Multivariate with Interactions"],"items":["\"Select\"","\"Dataset 1: Mostly Linear\"","\"Dataset 2: Nonlinear\"","\"Dataset 3: Complex\"","\"Dataset 4:Multivariate with Interactions\""],"label":"Select a dataset.","run":"Section"}
%---
%[text:image:3744]
%   data: {"align":"baseline","height":26,"src":"data:image\/png;base64,","width":19}
%---
...
%   data: {"align":"baseline","height":20,"src":"data:image\/png;base64,","width":22}
%---
%[control:dropdown:830a]
%   data: {"defaultValue":"\"Select\"","itemLabels":["Select","Linear Regression","Stepwise Regression","Regression Tree","Ensemble of Trees"],"items":["\"Select\"","\"Linear Regression\"","\"Stepwise Regression\"","\"Regression Tree\"","\"Ensemble of Trees\""],"label":"Select an answer.","run":"Section"}
%---
%[text:image:4185]
%   data: {"align":"baseline","height":20,"src":"data:image\/png;base64,","width":22}
%---
