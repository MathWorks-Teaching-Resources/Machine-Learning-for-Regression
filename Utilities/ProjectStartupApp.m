...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Text = 'Welcome to Machine Learning for Regression';
            ...
            app.Image.Position = [16 141 245 171];
            app.Image.ImageSource = 'MLforRegression.png';
            ...
            app.ReviewTitle.Text = 'Welcome to Machine Learning for Regression';
